...
public class View {
	...
	public virtual void Show() {
		...
		pool.CreateEntity()
			.AddTween(0.0f, 1.0f, EaseTypes.Linear, from, rectTransform.localPosition.x, 0.0f, onUpdate, OnShown);
		onUpdate(from);
	}
	...
	public virtual void Hide() {
		pool.CreateEntity()
			.AddTween(0.0f, 1.0f, EaseTypes.Linear, rectTransform.localPosition.x, rectTransform.localPosition.x + Screen.width, 0.0f, onUpdate, OnHidden);
	}
