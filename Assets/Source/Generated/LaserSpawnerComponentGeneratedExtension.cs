...
namespace Entitas {
    public partial class Entity {
        ...
        public Entity AddLaserSpawner(float newVelocity, float newHeight, Entitas.Entity newLaser) {
        ...
        public Entity ReplaceLaserSpawner(float newVelocity, float newHeight, Entitas.Entity newLaser) {
